...
public class MainServlet extends HttpServlet {
    ...
    @Override
    public void init() {
        Command[] commands = {new HomeCommand(), new UnpaidTaskCommand(), new ClientInfoCommand(), new WorkersWithRankCommand(), new LoginCommand(), new LogOutCommand(), new RegistrationCommand()};
